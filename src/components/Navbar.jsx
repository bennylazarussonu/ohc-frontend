import { FaUsers, FaPills, FaNotesMedical, FaFile, FaUserDoctor, FaUser, FaRightFromBracket, FaUserNurse } from "react-icons/fa6";
...
function Navbar({ border, active, onChange }) {
  ...
  const renderMenus = () => {
    ...
    if (user.role === "DOCTOR") return menus.slice(0, 5);
